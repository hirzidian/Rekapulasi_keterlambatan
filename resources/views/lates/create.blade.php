...
<h5><span style="color: blue">Data Keterlambatan/Tambah Data</span></h5>
        </div>
...
<form action="{{ route('admin.lates.store') }}" enctype="multipart/form-data" method="post">
    ...
    @endif
            ...
            <input type="datetime-local" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="date_time_late">
