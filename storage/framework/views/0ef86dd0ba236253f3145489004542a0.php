...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <br>
            <p><span>Nis</span>: <?php echo e($student->nis); ?></p>
            <p><span>Nama</span>: <?php echo e($student->name); ?></p>
            <p><span>Rombel</span>: <?php echo e($student->rombels->rombel); ?></p>
            <p><span>Rayon</span>: <?php echo e($student->rayons->rayon); ?></p>
        </div>

        <p>
            Dengan ini menyatakan bahwa saya telah melakukan pelanggaran tata tertib sekolah, yaitu terlambat datang ke
            sekolah sebanyak <strong><?php echo e($total . ' kali'); ?></strong> yang mana hal tersebut termasuk kedalam pelanggaran kedisiplinan.
            ...
            <div class="signature">
                <table>
                    <tr>
                        <td></td>
                        <td></td>
                        <td>Bogor, <?php echo e(\Carbon\Carbon::now()->format('d F Y')); ?></td>
                    </tr>
                    <tr>
                        <td>Peserta Didik,</td>
                        <td></td>
                    ...
                    <tr>
                        <td>( PS <?php echo e($student->rayons->rayon); ?>)</td>
                        <td></td>
                        <td>( ................ )</td>
                    </tr>
                </table>
...
</html><?php /**PATH E:\PORDUKTIF-XI-5\Uji_kelayakan\web-rekapitulasi\resources\views/lates/print/download.blade.php ENDPATH**/ ?>