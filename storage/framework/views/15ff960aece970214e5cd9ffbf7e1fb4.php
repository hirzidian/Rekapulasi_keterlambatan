...
<div class="container border py-4 rounded bg-secondary-subtle">
    ...
    <div class="d-flex justify-content-end mb-3">
        <a class="btn btn-secondary" href="<?php echo e(route('students.create')); ?>">Tambah</a>
    </div>
    <?php endif; ?>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $student; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td><?php echo e($item->rombel_id); ?></td>
                    <td><?php echo e($item->rayon_id); ?></td>
                    <?php if(Auth::check() && Auth::user()->role == "admin"): ?>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\applications\web-rekapitulasi\resources\views/students/index.blade.php ENDPATH**/ ?>